...
class MainRepositorylmpl @Inject constructor(
    private val weatherDao: WeatherDao,
    private val photoService: GoogleMapsRetrofitService,
    private val retrofitService: WeatherRetrofitConfig
) : MainRepository {

    override suspend fun fetchCity(city: String, apiKey: String): Resource<WeatherApiResult?> {
   ...
   override  fun getAllSearchedCities() = weatherDao.getAll()

    override suspend fun insertSearchedCity(searchedCity: WeatherApiResult) {
